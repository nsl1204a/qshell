...
class PAFDate extends PAFObject {
	...
	// Diferencia normal de 12 a 12 de la mañana
	...
	// $diferencia2 será menor que $diferencia si considerendo 
	// las horas la hora inicial es superior a la final y por tanto el ultimo día
    ...
    /**
      * Devuelve la diferencia en segundos entre la fecha actual y la pasada por parámetro.
      *
      * @param object $final
      * @return int
      */
    ...
    /**
      * Fija la hora con los valores pasados por parámetro.
      *
