...
/**
  ...
  * @package PAF
  */
class PAFSAXParser extends PAFObject
{
    /**
    ...
    /**
      ...
      */
    function PAFSAXParser (&$documentHandler, $encoding= ENCODING_ISO8859_1, $errorClass= null)
    {
		...
		if (1)
		{
	        ...
	        {
				$this->setPEARError($this->raiseError ("¡¡¡ ERROR !!! [PAFSAXParser] => No se ha proporcionado un manejador de documento correcto."));
				return;
			}
		}
		else
		...
		if (1)
		{
			...
			{
				$this->setPEARError ("¡¡¡ ERROR !!! [PAFSAXParser] => No se ha podido construir el parser.");
				return;
			}
		}
		else
