...
* @package PAF
*/
class PAFCacheBlock extends PAFObject
{
    /**
    ...
    function hashNameFile ($idCacheFile)
    {
        ...
        $id= substr ($idCacheFile, 0, 2);
		$id_sec = substr ($idCacheFile, 2, 2);
        ...
        $hash= $this->pathCache . "/" . $this->subdir . "/" . $id ."/". $id_sec ."/". $idCacheFile;
